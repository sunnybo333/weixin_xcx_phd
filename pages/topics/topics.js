...
Page({
  ...
  getData: function() {
    ...
    var get_data={tab:tab,user_type:'work_user',username: app.globalData.username,act: 'fetchGet',page:page};
  ...
  edit_level:function(e){
    ...
    var get_data={user_type:'work_user',act_type:'edit',act: 'edit_attention',id:id,value:level,color:color};
    Api.fetchGet(get_data,(err,res)=>{
  ...
  edit_ok:function(e){
    ...
    var get_data={user_type:'work_user',act_type:'edit',act: 'edit_ok',id:id,value:ok,color:color};
    Api.fetchGet(get_data,(err,res)=>{
      var item=that.data.postsList;
      that.data.postsList.map(function (item) {
        if(item.id==id){
  ...
  edit_workuser_submit:function(){
    ...
    var get_data={user_type:'work_user',act_type:'edit',act: 'work_user',id:id,value:new_workuser};
    Api.fetchGet(get_data,(err,res)=>{
      var item=that.data.postsList;
  ...
  edit_del:function(e){
    ...
    wx.showModal({
      ...
      success: function(res) {
        if (res.confirm) {
          var get_data={user_type:'work_user',act_type:'edit',act: 'edit_del',id:id,value:1};
          Api.fetchGet(get_data,(err,res)=>{
            var item=that.data.postsList;
            for(var i=0;i<item.length;i++){
              if(item[i]['id']==id){
  ...
  edit_remark_submit:function(){
    ...
    var get_data={user_type:'work_user',act_type:'edit',act: 'edit_remark',id:id,value:temp_remark};
    Api.fetchGet(get_data,(err,res)=>{
      var item=that.data.postsList;
      that.data.postsList.map(function (item) {
